...
class RedisClient():
    ...
    def add(self, proxy, score=INITIAL_SCORE):
        ...
        if not self.db.zscore(REDIS_KEY, proxy):
            # return self.db.zadd(REDIS_KEY, score, proxy) #error :redis 'int' object has no attribute 'items'
    ...
    def decrease(self, proxy):
        ...
        if score and score > MIN_SCORE:
            ...
            # return self.db.zincrby(REDIS_KEY, proxy, -1)   #error: redis.exceptions.ResponseError: value is not a valid float
