...
class WeibocnSpider(scrapy.Spider):
    ...
    # user_url = 'https://m.weibo.cn/api/container/getIndex?uid=3217179555&type=uid&value=3217179555&containerid=1005053217179555'
    follow_url = 'https://m.weibo.cn/api/container/getIndex?containerid=231051_-_followers_-_{uid}&page={page}'
    # follow_url = 'https://m.weibo.cn/api/container/getIndex?containerid=231051_-_followers_-_3217179555&page=1'
    fan_url = 'https://m.weibo.cn/api/container/getIndex?containerid=231051_-_fans_-_{uid}&page={page}'
    # fan_url = 'https://m.weibo.cn/api/container/getIndex?containerid=231051_-_fans_-_3217179555&page=1'
    weibo_url = 'https://m.weibo.cn/api/container/getIndex?uid={uid}&type=uid&page={page}&containerid=107603{uid}'
    # weibo_url = 'https://m.weibo.cn/api/container/getIndex?uid=3217179555&type=uid&page=1&containerid=1076033217179555'
    ...
    def parse_follows(self, response):
        ...
        if result.get('ok') and result.get('data').get('cards') and len(result.get('data').get('cards')) and result.get('data').get('cards')[-1].get('card_group'):
            ...
            follows = [
                {'id':follow.get('user').get('id'), 'name':follow.get('user').get('screen_name')} for follow in follows
            ]
